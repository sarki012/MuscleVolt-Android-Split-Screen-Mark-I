...
import com.esark.MuscleVoltSplitScreenMarkI.GameScreen;
import com.esark.MuscleVoltSplitScreenMarkI.R;
import com.esark.MuscleVoltSplitScreenMarkI.ConnectedThread;
import com.esark.MuscleVoltSplitScreenMarkI.MuscleVolt;
...
public abstract class AndroidGame extends Activity implements Game {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(isLandscape == true)
            ...
            landscape = 0;
        int frameBufferWidth = isLandscape ? 700 : 420;
        int frameBufferHeight = isLandscape ? 420 : 700;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            landscape = 1;
            Intent intent3 = new Intent(this.getApplicationContext(), MuscleVolt.class);
            this.startActivity(intent3);
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            landscape = 0;
            Intent intent4 = new Intent(this.getApplicationContext(), MuscleVolt.class);
